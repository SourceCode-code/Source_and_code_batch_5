...
let name = "Anand Tukaram Alankar";
...
let lastName = "Alankar";
console.log(firstName + " " + middleName + " " + lastName);
//Full Name: Anand Tukaram Alankar  
...
let newString = ' I tring to complete\
my pending \
assignments'
...
let newamount =45.85;
console.log(Math.floor (newamount));
console.log(Math.ceil (newamount));
...
let newstring = "qwertyuiopasdfghjklzxcvbnm";
console.log(newstring[Math.floor(Math.random()*newstring.length)]);