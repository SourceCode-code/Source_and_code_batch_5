...
console.log("Datatype of greeting variable is : ",typeof greeting);
...
let name = "Anurag Prashant Rasane"
...
let longString = "iopeunpfunaepfunaepirnvpaeinvpaiovnapoinvapeionprionvaprvnapnveprivnapoineprviouanerpvuonapunrpvuenvperunvpa\
eruvnaepruvnepruveprvunepruvnaepunaerpvunaeprvniearpvinaepoanpaoiunparunpaerunaperunvaerpuvnpunrvpn"
...
console.log("Length of the quote string is : ",quote.length)
console.log("The J is at index :",quote.indexOf("J"))
...
const str3 = "qwertyuiopasdfghjklzxcvbnm";

// generate random index
const randomIndex = Math.floor(Math.random() * str3.length);

// pick character
const randomChar = str3[randomIndex];
