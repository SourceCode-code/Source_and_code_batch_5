...
let newTime = dd.toLocaleTimeString("en-bg", {
  hour: "2-digit",
  minute: "2-digit",
});
let newDate = dd.toLocaleString("en-gb", {
  weekday: "long",
  month: "long",
  day: "2-digit",
  year: "numeric",
...
console.log(
  `The difference between ${date1.toLocaleDateString()} and ${date2.toLocaleDateString()} is ${diff}`,
);

//Question 4:
//Check if a current  year is a leap year.
let fullYear = dd.getFullYear();

if ((fullYear % 4 === 0 && fullYear % 100 !== 0) || fullYear % 400 === 0) {
  console.log(`${dd.getFullYear()} is leap year}`);
} else {
  console.log(`${dd.getFullYear()} is not leap year`);
}
