...
let myfirstname = `Samarth`
let mymiddlename = `Balaji`
...
let longgggg = `TypeScript understands JavaScript and uses type inference \to give you great tooling without additional code.`
console.log(longgggg);
...
let Quote = "Learning Javasript is Awesome"
...
let Relement = "qwertyuiopasdfghjklzxcvbnm";
let randomIndex = Math.floor(Math.random() * Relement.length);
let randomChar = Relement[randomIndex];
