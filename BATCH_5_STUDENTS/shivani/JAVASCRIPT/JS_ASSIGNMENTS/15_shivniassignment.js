...
let students= JSON.stringify(student,['firstName', 'lastName', 'skills'])
...
let txtjson1 = JSON.parse(txt)
console.log(txtjson1)
let maxSkills = 0;
let userWithMostSkills = '';

for (const user in txtjson1) {
  const skillCount = txtjson1[user].skills.length;
...
console.log(userWithMostSkills, maxSkills);
